  ...
  return (
    ...
    </div>
    {
     ...
     <ul className={`md:flex md:items-center md:pb-0 pb-6 absolute md:static bg-blue-950 text-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-6 transition-all duration-500 ease-in ${open ? 'top-20 ':'top-[-490px]'}`}>
      ...
      <li className="md:ml-8 py-1 text-xl md:my-0 cursor-pointer hover:text-gray-400"><Link to="/service">Services</Link></li>
      <li className="md:ml-8 py-1 text-xl md:my-0 cursor-pointer hover:text-gray-400"><Link to="/about">About</Link></li>
      <li className="md:ml-8 py-1 text-xl md:my-0 cursor-pointer hover:text-gray-400 "><Link to="/faq">FAQ</Link></li>
      <li className="md:ml-8 py-1 text-xl md:my-0 cursor-pointer hover:text-gray-400"><Link to="/contact">Contact</Link></li>
     </ul>
    }
    </div>
  </div>
